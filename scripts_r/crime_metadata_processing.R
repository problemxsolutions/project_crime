...
# For this, I went to the metadata page for one of the years (2015).  
...
# 35034fcb3b36499c84c94c069ab1a966/info/metadata/metadata.xml?format=default&output=html

# Download the html page
download.file(url = paste0('https://www.arcgis.com/sharing/rest/content/items/',
                           '35034fcb3b36499c84c94c069ab1a966/info/',
                           'metadata/metadata.xml?format=default&output=html'),
              destfile = './data/metadata_dc_crime_2015.html')
